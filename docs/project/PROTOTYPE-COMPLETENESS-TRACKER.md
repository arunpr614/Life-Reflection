...
- **Current state:** v12 Telegram Capture Companion is frozen at implementation/evidence commit `3927b55` and freeze record `689536c`; every v12 gate is `A`. Arun explicitly authorized v13 on 2026-08-16; v13 Telegram Duplicate Handling is **Implementation in progress** with P/D/C `A`, I `IP`, and Q `—`. V14 remains `Queued`.
