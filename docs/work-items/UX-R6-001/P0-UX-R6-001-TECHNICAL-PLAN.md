...
Translate **Text/Provider/Budget States** into a reversible, bounded implementation or evidence plan for this task only:

> Design title/summary/tag/brief review, field protection, stale suggestions, provenance, provider health, budget, and failure states.
...
- **Requirements:** `LID-AIT-002`, `LID-AIT-003`, `LID-AIT-004`, `LID-AIT-005`, `LID-AIT-007`, `LID-REF-006`, `LID-OPS-017`
...
1. **`UX-R6-001-T-001` — Boundary and failure:** invalid, absent, repeated, interrupted, or out-of-order inputs fail safely and leave no partial or falsely successful state.
2. **`UX-R6-001-T-002` — Recovery:** every persistent shape introduced or changed by this task is inventoried, backed up, restored in a separate empty path, compared, and rolled back or forward-fixed.
3. **`UX-R6-001-T-003` — Isolation:** privacy, security, resource, dependency, and co-resident failure cannot broaden access, leak sensitive data, or corrupt an accepted earlier release.
