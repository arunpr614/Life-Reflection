...
- Source visual truth: user-provided crop of the oversized disclosure (`2598 × 510` physical pixels); the temporary machine-local clipboard file was not retained in the repository.
