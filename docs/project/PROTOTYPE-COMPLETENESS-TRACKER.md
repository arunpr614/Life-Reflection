...
- **Current state:** v8 Cross-month Almanac is frozen at implementation/evidence commit `47f5af9` with freeze record `fd910f5`; v9 First-use Readiness has Product, Design, and Council approval and is in implementation
...
| **v9** | **PVA-004 First-use Readiness** — empty Calendar and separate VoiceNotes, Telegram, AI, Backup, and Recovery Ceremony readiness without credential collection or false recovery claims. | Audit gap 3, first-use portion | frozen v8; C-04 | **Implementation in progress** | A | A | A | IP | — | Standard v9 artifact set; [`../prototypes/v9/COUNCIL-v9.md`](../prototypes/v9/COUNCIL-v9.md); readiness-state matrix; `docs/prototypes/v9/` |
