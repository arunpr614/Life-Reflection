...
- **Current state:** v12 Telegram Capture Companion is frozen at implementation/evidence commit `3927b55` and freeze record `689536c`; every gate is `A`. V13 remains `Queued`, and no v13 preparation or implementation may begin without Arun's explicit confirmation.
