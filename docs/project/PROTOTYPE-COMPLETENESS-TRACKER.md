...
| `I — Prototype implementation` | Implementing agent | For v11 and later, new `P0-index-vN.html`, `P0-app-vN.js`, `P0-styles-vN.css`, `P0-README-vN.md`, P0-prefixed prototype note, and P0-prefixed current-run screenshots exist. Frozen v6–v10 names remain grandfathered and unchanged. Interactions change representative domain state rather than ending in a generic toast where the requirement demands a decision. |
...
For v11 and later, “Standard vN artifact set” means a new immutable `P0-index-vN.html`, `P0-app-vN.js`, `P0-styles-vN.css`, `P0-README-vN.md`, `docs/prototypes/P0-CALENDAR-UI-PROTOTYPE-vN.md`, `P0-design-qa-vN.md`, and P0-prefixed current-run evidence in `docs/prototypes/vN/`. Frozen v6–v10 artifacts retain their existing names and hashes.
