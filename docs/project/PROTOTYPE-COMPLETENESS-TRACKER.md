...
- **Current state:** v9 First-use Readiness is frozen at implementation/evidence commit `ae34415` with freeze record `5a12fb2`; v10 Resilient Application Shell has Product, Design, and Council approval and is in implementation
