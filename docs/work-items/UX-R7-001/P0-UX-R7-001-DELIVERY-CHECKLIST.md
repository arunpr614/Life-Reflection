...
- **GitHub issue:** [#46](https://github.com/arunpr614/Life-Reflection/issues/46)
- **GitHub Project:** [Phase 1 Delivery Project](https://github.com/users/arunpr614/projects/1)
- **Manifest task:** [UX-R7-001](../../project/PHASE1-ROADMAP-MANIFEST.json)
...
- **Status:** `Backlog`
- **Priority:** `Medium`
- **Proposed start:** 2027-01-12
- **Proposed target:** 2027-01-15
...
- `R7-OA-001` — due only at its named gate
