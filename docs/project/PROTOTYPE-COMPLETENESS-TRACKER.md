...
- **Current state:** v10 Resilient Application Shell is frozen at implementation/evidence commit `ffabe0d`, freeze record `497c98d`, and final tracker record `d3ef43a`; v11 Needs Date Review has started with Product, Design, and Council gates `A`, Implementation `IP`, and QA `—`
