...
| [Durable Manual Upload prototype v14](prototypes/CALENDAR-UI-PROTOTYPE-v14.md) | Ninth remediation slice: deliberate Journal Date choice, inert txt/md review, represented original identity and archive-wide duplicate decisions, guarded Retry, provenance, and derived pending/stale outcomes. Current authority is the handoff's line-6 frozen `Status:` written by documentation-only freeze record `303ae3c`, together with implementation/evidence commit `f5e75e3` and final tracker record `cf54d3b`. The immutable handoff's remaining IP/pending/not-frozen prose at lines 10, 107, 110, 112, and 118 is preserved historical pre-freeze snapshot text, not current status. |
| [Calendar UI v14 prototype guide](../prototypes/calendar-ui/README-v14.md) | Local run instructions, passed manual-upload contract, exact frozen fingerprint, and 22/22 independently verified current-run frames. The authoritative frozen chain is implementation/evidence commit `f5e75e3`, the handoff line-6 `Status:` written by `303ae3c`, and final tracker record `cf54d3b`; contradictory prose retained elsewhere in the immutable handoff is a historical pre-freeze snapshot, not current status. |
| [Durable Manual Upload v14 council](prototypes/v14/COUNCIL-v14.md) | Approved Product, Design, and Project contract used by the independent Pass on the exact frozen 22-frame set. The frozen chain is implementation/evidence commit `f5e75e3`, documentation-only freeze record `303ae3c`, and final tracker record `cf54d3b`. |
| [Upload fixture sheet v14](prototypes/v14/UPLOAD-FIXTURES-v14.md) | Exact fictional entry, validation, review, duplicate, failure, race, provenance, privacy, focus/history, responsive, and frozen 22-frame evidence roster. Bound by implementation/evidence commit `f5e75e3`, documentation-only freeze record `303ae3c`, and final tracker record `cf54d3b`. |
| [Durable Manual Upload v14 independent QA](../design-qa-v14.md) | Final Pass report for the exact nine-file UI fingerprint, separate package artifact, frozen 22/22 evidence set, complete Council §18 and fixture coverage, 168/168 frozen v6–v13 comparison, and 0/0/0/0 unresolved findings. The final chain is implementation/evidence commit `f5e75e3`, documentation-only freeze record `303ae3c`, and tracker record `cf54d3b`. |
| [Correction Editor prototype v15](prototypes/CALENDAR-UI-PROTOTYPE-v15.md) | Tenth remediation-slice handoff for Source Item-bound text Corrections. The post-QA/pre-commit snapshot records the exact candidate and 22-frame evidence set independently passed by `/root/v15_independent_qa_final2` with Critical 0, High 0, Medium 0, Low 0; Implementation is IP, the implementation/evidence commit is pending, and v15 is not frozen at that snapshot. Later commit/freeze authority belongs to the handoff `Status:` line and append-only tracker. |
| [Calendar UI v15 prototype guide](../prototypes/calendar-ui/README-v15.md) | Local run instructions, exact held candidate fingerprint, Correction interaction contract, and 22/22 independently verified current-run evidence manifest. The post-QA/pre-commit snapshot records Q=A and I=IP; the implementation/evidence commit and freeze remain later gates governed by the handoff and tracker. |
